...
### 2 — Qual a casa e quais os parlamentares mais ativos no Twitter?

Para determinar qual das casas do Congresso Nacional e quais os parlamentares mais ativos no Twitter, será utilizada a soma do número de tweets e retweets de cada parlamentar, agrupando-os pela casa a que pertencem. Considerando a diferença do número de eleitos em cada casa (513 deputados e 81 senadores), adotou-se a mediana dessa soma como métrica.
...
É perceptível que o Senado atingiu uma mediana consideravelmente superior à Câmara, trazendo a conclusão que esta é proporcionalmente a casa mais *twitteira* do Congresso Nacional brasileiro. Além disso, também é possível notar a existência de uma grande quantidade de deputados inativos em suas contas do Twitter.

Quanto aos parlamentares, foi possível perceber que o deputado Bacelar mostra-se muito mais ativo nessa rede social, não somente em relação aos seus pares, mas também aos senadores. Já no Senado, Álvaro Dias, Humberto Costa e Jorge Kajuru são aqueles que não param de *tweetar*.

### 3 — Quais os partidos mais populares do Twitter?

```{r warning = FALSE, message = FALSE, error = FALSE}
# Scatterplot "Seguindo x Seguidores"
```
